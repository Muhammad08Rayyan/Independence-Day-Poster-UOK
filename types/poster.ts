// Mobile-optimized TypeScript types for Pakistan Independence Day Poster Generator
...
export interface PosterStyle {
  ...
  description: string;
  thumbnail: string;
  category: 'traditional' | 'modern' | 'artistic' | 'professional' | 'youth' | 'cultural';
  config: StyleConfig;
}
...
export interface QuickMessage {
  id: string;
  text: string;
  category: 'patriotic' | 'professional' | 'personal' | 'medical';
}

export interface PosterConfig {
  dimensions: PosterDimensions;
  colors: {
    primary: string;      // Pakistan green
