...
const PosterForm: React.FC<PosterFormProps> = ({ 
  ...
  const handleFormSubmit = (data: PosterFormData) => {
    ...
    if (!data.message.trim()) {
      toast.error('Please enter an Independence Day message');
      return;
    }
  ...
  const quickMessages = [
    { text: 'I am proud to be a Pakistani', label: 'Proud Pakistani' },
    { text: 'I will resprect and protect the dignity, sovereignty and progress of my country', label: 'Respect & Protect' },
    { text: 'I will stand against extremism, hatred and corruption', label: 'Stand Against Extremism' },
    { text: 'I will contribute to the development of Pakistan through education, service and honesty', label: 'Contribute to Pakistan' },
    { text: 'Happy Independence Day, Pakistan!', label: 'Happy Independence' },
    { text: 'Freedom is a blessing, and Pakistan is our pride.', label: 'Freedom is a Blessing' },
    { text: 'Jashn-e-Azadi Mubarak ho!', label: 'Jashn Mubarak' },
    { text: 'Azadi ka din hai - let\'s celebrate it with pride!', label: 'Azadi Pride' },
    { text: 'Pakistan lives in every heart. Let\'s rise as one nation under one flag.', label: 'One Nation' },
    { text: 'As a doctor, I pledge to serve this nation with compassion, integrity, and care.', label: 'Doctor\'s Pledge' }
  ];
    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      >
        <h3 className="text-[16px] mb-[14px] text-white font-semibold text-center relative pb-2">
          ...
          Quick Independence Day Messages:
        </h3>
          ...
          <AnimatePresence mode="wait">
            {generationState.isGenerating ? (
              ...
              <motion.span
                ...
                exit={{ opacity: 0 }}
              >
                Generate Independence Day Poster
              </motion.span>
            )}
          </AnimatePresence>
        </button>
